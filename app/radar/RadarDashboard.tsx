...
export default function RadarDashboard({ seedOpportunities, seedSellers: sellers, seedRules: rules }: RadarDashboardProps) {
  ...
  const [showImport,setShowImport] = useState(false); const [showNew,setShowNew] = useState(false); const [linkEditingId,setLinkEditingId] = useState<string|null>(null); const [notice,setNotice] = useState("");
